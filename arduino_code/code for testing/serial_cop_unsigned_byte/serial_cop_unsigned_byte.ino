...
//  }
  ...
  if((state > 0) and (state < 15)){ // standby
    if (state != prevState){
  ...
  }else if((state > 0) and (state < 30)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 45)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 60)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
...
//        digitalWrite(rfw,HIGH);
  ...
  }else if((state > 0) and (state < 75)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
...
//        digitalWrite(rfw,HIGH);
  ...
  }else if((state > 0) and (state < 90)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 105)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 120)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
...
//        digitalWrite(lfw,HIGH);
  ...
  }if((state > 0) and (state < 135)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 150)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 165)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 180)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
...
//        digitalWrite(lfw,HIGH);
  ...
  }else if((state > 0) and (state < 195)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
...
//        digitalWrite(rfa,HIGH);
  ...
  }else if((state > 0) and (state < 210)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 225)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
  ...
  }else if((state > 0) and (state < 240)){ // standby
    if (state != prevState){
      digitalWrite(prevpin1,LOW);
      digitalWrite(prevpin2,LOW);
      delay(75);
